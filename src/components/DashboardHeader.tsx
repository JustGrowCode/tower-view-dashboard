      ...
      <div className="container mx-auto">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#222a3d] p-4 rounded-lg border border-[#2e3b52] text-center">
            ...
            <div className="text-xs text-[#9b87f5]">Terreno + Estrutura + Equipamentos</div>
          </div>
          
          <div className="bg-[#222a3d] p-4 rounded-lg border border-[#2e3b52] text-center">
            <div className="text-sm text-gray-400 mb-1">Retorno Mensal</div>
            <div className="text-2xl font-bold text-white">R$ {formatCurrency(tower.returns.monthly)}</div>
            <div className="text-xs text-[#9b87f5]">
              {((tower.returns.monthly * 12) / tower.investment.total * 100).toFixed(2)}% a.a.
            </div>
          </div>
          
          <div className="bg-[#222a3d] p-4 rounded-lg border border-[#2e3b52] text-center">
            <div className="text-sm text-gray-400 mb-1">ROI Total ({tower.contract.duration} anos)</div>
            <div className="text-2xl font-bold text-[#9b87f5]">{tower.returns.roi.toFixed(2)}%</div>
